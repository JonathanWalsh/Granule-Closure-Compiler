...
public class InlineFunctionsTest extends CompilerTestCase {
  ...
  public void testComplexSample() {
      ...
      if (major == '1' && minor == '5')
          result = "" +
                  "{{" +
                  "var styleSheet$$inline_6=null;" +
                  "if(goog$userAgent$IE)" +
                  "styleSheet$$inline_6=0;" +
                  "else " +
                  "var head$$inline_7=0;" +
                  "{" +
                  "var element$$inline_3=" +
                  "styleSheet$$inline_6;" +
                  "var stylesString$$inline_4=a;" +
                  "if(goog$userAgent$IE)" +
                  "element$$inline_3.cssText=" +
                  "stylesString$$inline_4;" +
                  "else " +
                  "{" +
                  "var propToSet$$inline_5=" +
                  "\"innerText\";" +
                  "element$$inline_3[" +
                  "propToSet$$inline_5]=" +
                  "stylesString$$inline_4" +
