...
class OptimizeParametersAlt extends AbstractPostOrderCallback
  ...
  private class Declaration {
     ...
     */
    public com.granule.java6emul.LinkedList<FormalParameter> parameters;
    ...
    Declaration(Node node, com.granule.java6emul.LinkedList<FormalParameter> parameters,
  ...
  void addDeclaration(String name, Scope scope, Declaration declaration) {
    ...
    if (name.length()==0 || compiler.getCodingConvention().isExported(name)) {
      return;
    }
  ...
  private void checkIfFunctionIsSafe(NodeTraversal t, Node node, Node parent) {
    ...
    com.granule.java6emul.LinkedList<FormalParameter> parameters =
        new com.granule.java6emul.LinkedList<FormalParameter>();
  ...
  private void tryEliminateConstantArgs(Declaration declaration) {
    ...
    com.granule.java6emul.LinkedList<Integer> indexes = new com.granule.java6emul.LinkedList<Integer>();
