...
public class NodeTraversal {
   ...
   * {@link #getControlFlowGraph()}. Note that {@link com.granule.java6emul.ArrayDeque} does not allow
   * {@code null} elements, so {@link LinkedList} is used instead.
   */
  Deque<ControlFlowGraph<Node>> cfgs = new com.granule.java6emul.LinkedList<ControlFlowGraph<Node>>();
